...
[![GoDoc](https://godoc.org/github.com/ZohraS/ozzo-routing?status.png)](http://godoc.org/github.com/ZohraS/ozzo-routing)
[![Build Status](https://travis-ci.org/ZohraS/ozzo-routing.svg?branch=master)](https://travis-ci.org/ZohraS/ozzo-routing)
[![Coverage Status](https://coveralls.io/repos/github/ZohraS/ozzo-routing/badge.svg?branch=master)](https://coveralls.io/github/ZohraS/ozzo-routing?branch=master)
[![Go Report](https://goreportcard.com/badge/github.com/ZohraS/ozzo-routing)](https://goreportcard.com/report/github.com/ZohraS/ozzo-routing)
...
```
go get github.com/ZohraS/ozzo-routing
```

You may also get specified release of the package by:

```
go get gopkg.in/ZohraS/ozzo-routing.v1
```
...
--------------------------------|--------------------------------------------
[access.Logger](https://godoc.org/github.com/ZohraS/ozzo-routing/access) | records an entry for every incoming request
[auth.Basic](https://godoc.org/github.com/ZohraS/ozzo-routing/auth) | provides authentication via HTTP Basic
[auth.Bearer](https://godoc.org/github.com/ZohraS/ozzo-routing/auth) | provides authentication via HTTP Bearer
[auth.Query](https://godoc.org/github.com/ZohraS/ozzo-routing/auth) | provides authentication via token-based query parameter
[auth.JWT](https://godoc.org/github.com/ZohraS/ozzo-routing/auth) | provides JWT-based authentication
[content.TypeNegotiator](https://godoc.org/github.com/ZohraS/ozzo-routing/content) | supports content negotiation by response types
[content.LanguageNegotiator](https://godoc.org/github.com/ZohraS/ozzo-routing/content) | supports content negotiation by accepted languages
[cors.Handler](https://godoc.org/github.com/ZohraS/ozzo-routing/cors) | implements the CORS (Cross Origin Resource Sharing) specification from the W3C
[fault.Recovery](https://godoc.org/github.com/ZohraS/ozzo-routing/fault) | recovers from panics and handles errors returned by handlers
[fault.PanicHandler](https://godoc.org/github.com/ZohraS/ozzo-routing/fault) | recovers from panics happened in the handlers
[fault.ErrorHandler](https://godoc.org/github.com/ZohraS/ozzo-routing/fault) | handles errors returned by handlers by writing them in an appropriate format to the response
[file.Server](https://godoc.org/github.com/ZohraS/ozzo-routing/file) | serves the files under the specified folder as response content
[file.Content](https://godoc.org/github.com/ZohraS/ozzo-routing/file) | serves the content of the specified file as the response
[slash.Remover](https://godoc.org/github.com/ZohraS/ozzo-routing/slash) | removes the trailing slashes from the request URL and redirects to the proper URL
